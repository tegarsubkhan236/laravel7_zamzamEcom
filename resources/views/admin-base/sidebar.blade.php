    ...
    <div class="sidebar-scroll">
        <nav>
            <ul class="nav">
                ...
                <hr>
                <li><a href="{{url('/category')}}" class="{{ request()->is('category') ? 'active' : '' }}"><i class="lnr lnr-list"></i> <span> Produk</span></a></li>
                @if (Auth::user()->role == "admin" || Auth::user()->role == "owner")
                    <li><a href="{{url('/produk')}}" class="{{ request()->is('produk') ? 'active' : '' }}"><i class="lnr lnr-diamond"></i> <span> Portofolio</span></a></li>
                @endif
                <hr>
